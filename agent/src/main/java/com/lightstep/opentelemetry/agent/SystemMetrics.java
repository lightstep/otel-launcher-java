...
import io.opentelemetry.javaagent.shaded.io.opentelemetry.api.metrics.AsynchronousInstrument.Callback;
import io.opentelemetry.javaagent.shaded.io.opentelemetry.api.metrics.AsynchronousInstrument.DoubleResult;
import io.opentelemetry.javaagent.shaded.io.opentelemetry.api.metrics.AsynchronousInstrument.LongResult;
...
public class SystemMetrics {
   ...
   */
  public static void registerObserversInt() {
    Meter meter = OpenTelemetry.getGlobalMeterProvider().get("SystemMetrics");
